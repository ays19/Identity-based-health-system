        ...
        <div class="col-md-8">
          ...
          <div class="card mb-4">
            <?php
                ...
                $query = mysqli_query($conn,"SELECT * FROM patient inner join person on person.nid = patient.p_nid inner join prescription on prescription.p_nid = patient.p_nid where prescription.d_nid = '$user_id' group by patient.p_nid");
            ...
            <div class="card-body" style="border: 1px solid gray; position:relative; border-radius: 20px;">
                ...
                <div style="top: 20px;left: 75px;; position:absolute;"><a href="docseepatient.php?id=<?php echo $patient_row['nid']; ?>&a=<?php echo 'mo'; ?>"><?php echo $patient_row['name']; ?></a></div>
